...
> **TL;DR:** This system is designed to work with custom development modes, where each mode loads only the rules it needs. The system uses visual Mermaid diagrams and selective document loading to optimize context usage.

## 🧭 MODE-SPECIFIC VISUAL MAPS

```mermaid
graph TD
    subgraph Modes["Custom Development Modes"]
...
- [VAN Mode Map](.github/instructions/visual-maps/van-mode-map.md)
- [PLAN Mode Map](.github/instructions/visual-maps/plan-mode-map.md)
- [CREATIVE Mode Map](.github/instructions/visual-maps/creative-mode-map.md)
- [IMPLEMENT Mode Map](.github/instructions/visual-maps/implement-mode-map.md)
- [REFLECT Mode Map](.github/instructions/visual-maps/reflect-mode-map.md)
- [ARCHIVE Mode Map](.github/instructions/visual-maps/archive-mode-map.md)
...
Refer to [command-execution.md](.github/instructions/Core/command-execution.md) for detailed guidance. 